IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[support_ExportScheduler]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[support_ExportScheduler]
GO
...
CREATE PROCEDURE [dbo].[support_ExportScheduler]
	  @beginDateOffset int
	, @endDateOffset int
