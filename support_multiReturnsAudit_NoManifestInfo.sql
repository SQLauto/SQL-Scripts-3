IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[support_multiReturnsAudit_NoManifestInfo]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[support_multiReturnsAudit_NoManifestInfo]
GO
...
CREATE PROCEDURE [dbo].[support_multiReturnsAudit_NoManifestInfo]
...
BEGIN
	...
	*/
	...
	select ra.DrawId, ra.DrawDate, ra.AccountId, ra.PublicationId, ra.ReturnsAuditId, ra.RetAuditUser, ra.RetAuditDate, Diff--, m.AcctCode, m.PubShortName
