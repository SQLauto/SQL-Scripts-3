...
begin
	...
	set @CustomExportPropertyName = 'CustomExportConfigFile_Forecast_' + @pub
	set @CustomExportDescription = 'CustomExport_Forecast_' + @pub
	set @CustomExportConfigFileName = 'CustomExport_Forecast_' + @pub + '.xml'
