...
begin
	...
	print 'deleting data from table [scProductLineItemDetails]'
	delete scProductLineItemDetails
	print '  ' + cast(@@rowcount as varchar) + ' deleted from scProductLineItemDetails'
	print ''

	print 'deleting data from table [scNonProductLineItemDetails]'
	delete scNonProductLineItemDetails
	print '  ' + cast(@@rowcount as varchar) + ' deleted from scNonProductLineItemDetails'
	print ''
	
	print 'deleting data from table [scNonProductTransactions]'
	delete scNonProductTransactions
	print '  ' + cast(@@rowcount as varchar) + ' deleted from scNonProductTransactions'
	print ''
	
	print 'deleting data from table [scInvoiceLineItems]'
	...
	print 'deleting data from table [scInvoiceMastersPayments]'
	delete scInvoiceMastersPayments 
	print '  ' + cast(@@rowcount as varchar) + ' deleted from scInvoiceMastersPayments'
	print ''

	print 'deleting data from table [scInvoiceMastersPaymentsDisplay]'
	delete scInvoiceMastersPaymentsDisplay 
	print '  ' + cast(@@rowcount as varchar) + ' deleted from scInvoiceMastersPaymentsDisplay'
	print ''
	...
	print 'deleting data from table [scPaymentsARAccountBalances]'
	...
	print 'deleting data from table [scPayments]'
	delete scPayments
...
begin
	...
	print 'deleting data from table [syncSystemLogAlertsSent]...'
	delete from syncSystemLogAlertsSent
	print cast(@@rowcount as varchar) + ' rows deleted from [syncSystemLogAlertsSent]...'
	print ''
	
	print 'deleting data from table [syncSystemLog]...'
	delete syncSystemLog
	print cast(@@rowcount as varchar) + ' rows deleted from [syncSystemLog]...'
	print ''
