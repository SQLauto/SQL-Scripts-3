IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[syncIndexMaintenance]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[syncIndexMaintenance]
GO
...
CREATE PROCEDURE [dbo].[syncIndexMaintenance]
	  @db_name nvarchar(50)
	, @fillfactor int = 100
...
GRANT EXECUTE ON [dbo].[syncIndexMaintenance] to [nsUser]
GO