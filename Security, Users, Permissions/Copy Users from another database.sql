...
from nsdb_ajc..Users u
join nsdb_ajc..Logins l
	on u.UserID = l.UserID

insert into #groups ( GroupName, Description, AccessMask )
select GroupName, Description, AccessMask
from nsdb_ajc..Groups g
join nsdb_ajc..GroupACL gacl
	on g.GroupID = gacl.GroupID
join nsdb_ajc..SecuredObjects obj
	on gacl.SecuredObjectID = obj.SecuredObjectID
	
insert into #usergroups (UserName, GroupName)
select u.UserName, g.GroupName
from nsdb_ajc..Users u
join nsdb_ajc..UserGroups ug
	on u.UserID = ug.UserID
join nsdb_ajc..Groups g
